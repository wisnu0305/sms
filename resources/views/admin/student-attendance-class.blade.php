    ...
    <div class="container">
        <div class="card card-custom ">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-4">
                        <form action="{{ route('admin.student-attendance-class', ['idKelas' => $idKelas]) }}"
                            method="GET">
                    ...
                    <div class="col-5 text-right">
                        <a href="{{ route('admin.student-attendance-data') }}" type="button" class="btn btn-success"><i
                    ...
                    <div class="row table-responsive mx-3">
                        ...
                        <div class="d-flex justify-content-between align-items-center flex-wrap">
                            <div class="d-flex align-items-center py-3">
                                ...
                                <form method="GET"
                                    action="{{ route('admin.student-attendance-class', ['idKelas' => $idKelas]) }}">
                                    <select id="entries"
        ...
        <script>
            $(document).ready(function() {
                $(document).on('change', '#entries', function() {
                    window.location =
                        "{{ route('admin.student-attendance-class', ['idKelas' => $idKelas]) }}?search={{ request('search') }}&per_page=" +
                        $(this)
                        .val();
                });
            });
